...
<div class="teacher_section">
      ...
      <div id="add_teacher" class="teacher_tabcontent">
        <form autocomplete="off" id="formData">
          ...
          <input type="submit" id="sub_teacher_btn" style="background-color:#7db9b6; display:flex; width:150px;justify-content:center; border-radius:10px;box-shadow:2px 2px 5px black"></input>
          </div>
