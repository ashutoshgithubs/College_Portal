<div class="library_header">
             ...
             <div class="library_data">
               <div class="library_data_header">
                 <h1>Library Data Record</h1>
                 <button class="library_data_btn" id="add_library" style="background-color:#7db9b6; border-radius:8px">Add</button>
               </div>
