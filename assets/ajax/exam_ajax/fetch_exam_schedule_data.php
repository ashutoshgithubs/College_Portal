...
<table id='exam_table'>
                    <tr>
                        <th style='background-color:#7db9b6'>Exam Name</th>
                        <th style='background-color:#7db9b6'>Exam Subject</th>
                        <th style='background-color:#7db9b6'>Year</th>
                        <th style='background-color:#7db9b6'>Section</th>
                        <th style='background-color:#7db9b6'>Time</th>
                        <th style='border-right:none;background-color:#7db9b6'>Date</th>
                        <th style='border-left:none;background-color:#7db9b6'></th>
                     </tr>   
