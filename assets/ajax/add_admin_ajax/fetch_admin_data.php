...
<table id='add_admin_table'>
                    <tr>
                        ...
                        <th style='background-color:#7db9b6'>Name</th>
                        <th style='background-color:#7db9b6'>Email</th>
                        <th style='background-color:#7db9b6'>Password</th>
                        <th style='background-color:#7db9b6'>Confirm Password</th>
                        <th style='background-color:#7db9b6'>Image</th>
                        <th style='border-right:none; background-color:#7db9b6'>Role</th>
