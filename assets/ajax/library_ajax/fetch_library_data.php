...
<table id='library_table'>
                    <tr>
                        <th style='width:100px;background-color:#7db9b6'>ID</th>
                        <th style='background-color:#7db9b6'>Book Name</th>
                        <th style='background-color:#7db9b6'>Subject</th>
                        <th style='background-color:#7db9b6'>Writer</th>
                        <th style='background-color:#7db9b6'>Year</th></th>
                        <th style='background-color:#7db9b6'>Publish</th>
                        <th  style='border-right:none;background-color:#7db9b6'>Creation Date</th>
                        <th style='border-left:none;width:60px;background-color:#7db9b6'></th>
                     </tr>   
